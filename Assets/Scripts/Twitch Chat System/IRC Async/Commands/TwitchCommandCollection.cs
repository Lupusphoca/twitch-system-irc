namespace PierreARNAUDET.TwitchChat
{
    ...
    public class TwitchCommandCollection
    {
        ...
        public TwitchCommandCollection()
        {
            ...
            // Add here every command that you have created and you want to implement in the dictionnary, for example :
        ...
        public void ExecuteCommand(string command, TwitchData.TwitchCommandData data)
        {
            ...
            if (HasCommand(command) /* Add here badges and roles verifications with a dedicated function */)
            {
